...
public class BoardService {
    ...
    public List<BoardResponseDto> getAllPosts() {
        ...
        for(Board post: posts){
            ...
            for(Comment comment : comments){
                CommentResponseDto commentResponsDto = new CommentResponseDto(comment);
                commentResponseDtos.add(commentResponsDto);
            }
            BoardResponseDto boardResponseDto = new BoardResponseDto(post, commentResponseDtos);
    ...
    public List<BoardResponseDto> getPosts(HttpServletRequest request){
    ...
    public BoardResponseDto createPost(BoardRequestDto boardRequestDto, HttpServletRequest request) {
        ...
        ArrayList<CommentResponseDto> commentResponsDtos = new ArrayList<>();
        boardRepository.save(post);
        return new BoardResponseDto(post, commentResponsDtos);
    }
    ...
    public BoardResponseDto getPost(Long postId) {
        ...
        return new BoardResponseDto(post, commentResponseDtos);
    }

    @Transactional
    // 유저 확인 후 수정
    // XXX: 여기서는 사실 commentResponseDtos를 날려줄 필요가 없긴한데
    public BoardResponseDto updatePost(Long postId, BoardRequestDto boardRequestDto, HttpServletRequest request) {
        User user = userService.isLogin(request);
        ArrayList<CommentResponseDto> commentResponsDtos = new ArrayList<>();
